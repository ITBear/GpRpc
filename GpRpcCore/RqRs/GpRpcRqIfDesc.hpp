...
public:
    ...
    REFLECT_DECLARE(u8"6f7f6db1-67f0-4425-97ee-6e0eecbc3e2d"_uuid)
...
public:
    ...
    virtual std::u8string_view  Method          (void) const;
    virtual void                SetMethod       (std::u8string_view aMethod);
